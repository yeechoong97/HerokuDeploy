...
<div class="learning-container">
    <div class="row learning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 4780px;">
            ...
            <p>*Adapted from <b>Person, J. L. (2004). Complete Guide to Technical Trading Tactics.</b></p>
        </div>
        </div>
    </div>
</div>
