...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2980px;">
            ...
            <img src ="{{asset('pictures/SymmetricalTriangle.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/AscendingTriangle.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/DescendingTriangle.png')}}" class="img-padding" >
