...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 3480px;">
            ...
            <img src ="{{asset('pictures/HeadAndShoulders.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/InverseHeadAndShoulders.png')}}" class="img-padding" >
