...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 3000px;">
            ...
            <ol>
                <li>The underlying currency pair</li>
                <li>The direction (long or short)</li>
                <li>The size</li>
            </ol>
            ...
            <img src ="{{asset('pictures/LongVsShort.jpg')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/Long.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/Short.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Bradfield, D. (2019). Long vs Short Positions in Forex Trading. https://www.dailyfx.com/education/beginner/long-vs-short-positions-in-forex-trading.html</b></p>
        </div>
        </div>
    </div>
</div>
