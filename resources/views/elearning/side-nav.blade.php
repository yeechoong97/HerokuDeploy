<div class="col-md-6 col-xl-2 offset-xl-0 sidenav">
    <div class="sidenav-menu">
        ...
        <a class="dropdown-btn" href="#">Japanese Candlestick Patterns<i class="fas fa-plus"></i></a>
            <div class="dropdown-container">
        ...
        <a class="dropdown-btn" href="#">Fundamental Analysis<i class="fas fa-plus"></i></a>
            <div class="dropdown-container">
                ...
                <!-- <a href="{{route('learning-watch')}}">What to Watch</a> -->
            </div>
        ...
        <a class="dropdown-btn" href="#">Technical Indicator<i class="fas fa-plus"></i></a>
            <div class="dropdown-container">
                <a href="{{route('learning-indicator-intro')}}">Technical Indicator Intro</a>
