    ...
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1500px;">
            <div class="sidenav-content-details">
                ...
                <img src ="https://res.cloudinary.com/fyp202105/image/upload/v1612761384/E-Learning/ForexIntro.jpg" class="img-padding" alt="forex-intro">
                <div class="img-citation">Image retrieved from <cite>Snow, R. (2018). What is Forex? Forex Trading Explained. https://www.dailyfx.com/education/beginner/what-is-forex.html</cite></div>
                ...
                <p>Forex has no centralized market, unlike many other securities. There is no single centralized place for the trade of forex. Traders buy and sell forex via telephones and computers linked to brokers, bank and other traders around the world. You will often hear the term <strong class="l-size">INTERBANK</strong> discussed in forex terminology. This originally, as the name implies, was simply, banks and large institutions exchanging information about the current rate of exchange at which their clients or themselves were prepared to buy or sell a currency. <strong class="l-size">INTER</strong> meaning between and <strong class="l-size">Bank</strong> meaning deposit-taking institutions – normally made up of banks, large institution, brokers or even the government.</p>
                ...
                <p class="blockquote-footer citation">Adapted from <cite>Mark McRae. (2008). Sure-fire Forex Trading.</cite></p>
            </div>
        </div>
    </div>
</div>
