...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1680px;">
            ...
            <img src ="{{asset('pictures/Breakout.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Mitchell, C. (2020b). Breakout Definition and Example. https://www.investopedia.com/terms/b/breakout.asp/</b></p>
        </div>
        </div>
    </div>
</div>
