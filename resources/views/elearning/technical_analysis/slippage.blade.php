...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2100px;">
            ...
            <img src ="{{asset('pictures/Slippage.png')}}" class="img-padding" >
            ...
            <ul>
                <li><b class="l-size">No Slippage</b></li>
                ...
                <li><b class="l-size">Positive Slippage</b></li>
                ...
                <li><b class="l-size">Negative Slippage</b></li>
            ...
            <p>*Adapted from <b>Forex.com. (2021e). What is Slippage? Slippage in Forex Explained. https://www.dailyfx.com/education/forex-trading-basics/what-is-slippage.html</b></p>
        </div>
        </div>
    </div>
</div>
