...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1680px;">
            ...
            <img src ="{{asset('pictures/TechnicalAnalysisChart.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Forex.com. (2021e). Understanding Technical Analysis. https://www.forex.com/en/education/resources-by-level/beginner/understanding-technical-analysis/</b></p>
        </div>
        </div>
    </div>
</div>
