...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 3580px;">
            <div class="sidenav-content-details">
            <h3 id="learning-title">Gaps</h3>
            <img src ="{{asset('pictures/MarketGaps.svg')}}" class="img-padding" >
            ...
            <h5>Types of Gaps</h5>
            <ol>
                <li><b class="l-size">Gap down/up</b></li>
                ...
                <li><b class="l-size">Common gaps</b></li>
                ...
                <li><b class="l-size">Breakway gaps</b></li>
                ...
                <img src ="{{asset('pictures/Breakway.png')}}" class="img-padding" >
                <li><b class="l-size">Continuation or runaway gaps</b></li>
                ...
                <img src ="{{asset('pictures/Continuation.png')}}" class="img-padding" >
                <li><b class="l-size">Exhaustion gaps</b></li>
                ...
                <img src ="{{asset('pictures/Exhaustion.png')}}" class="img-padding" >
            </ol>
            ...
            <ul>
                <li><b class="l-size">Price corrections</b>: An overly optimistic or pessimistic initial spike may invite a correction.</li>
                <li><b class="l-size">Support and resistance</b> isn’t left behind when a price moves up or down sharply.</li>
                <li><b class="l-size">Patterns</b>: Price patterns dictate the likelihood of a gap being filled. For example, price reversals seen with exhaustion gaps are likely to be filled as this type of gap signals the end of a price trend.</li>
            </ul>
            <p>*Adapted from <b>Lobel, B. (2019). Trading the Gap: What are Gaps & How to Trade Them? https://www.dailyfx.com/forex/education/trading_tips/daily_trading_lesson/2019/10/29/gap-trading-strategies.html</b></p>
            <p>*Adapted from <b>Forex.com. (2021b). Understanding Market Gaps and Slippage. https://www.forex.com/en/education/education-themes/trading-concepts/understanding-market-gaps-and-slippage/</b></p>
        </div>
        </div>
    </div>
</div>
