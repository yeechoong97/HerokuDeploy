...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1700px;">
            ...
            <img src ="{{asset('pictures/Spread.png')}}" class="img-padding" >
            ...
            <h2 style="text-align:center">1.4 (Spread in Pips) x $1 (Pip Cost per 10k Lot) = $1.4 (Spread Cost)</h2><br>
            ...
            <p>*Adapted from <b>Bradfield, D. (2019b). What Does a Forex Spread Tell Traders? https://www.dailyfx.com/education/forex-trading-basics/what-does-a-spread-tell-forex-traders.html</b></p>
        </div>
        </div>
    </div>
</div>
