...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2880px;">
            ...
            <h6><b class="l-size">Example of EUR/USD Forex Quote</b></h6>
            <img src ="{{asset('pictures/Quote.png')}}" class="img-padding" >
            ...
            <ul>
                ...
                <li><b>Base currency and variable currency</b></li>
            ...
            <img src ="{{asset('pictures/Pips.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Snow, R. (2019). How to Read Currency Pairs: Forex Quotes Explained. https://www.dailyfx.com/education/beginner/how-to-read-currency-pairs.html</b></p>
        </div>
        </div>
    </div>
</div>
