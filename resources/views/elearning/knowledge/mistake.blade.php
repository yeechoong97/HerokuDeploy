...
<div class="elearning-container">
    <div class="row elearning-container">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1600px;">
            ...
            <img src ="{{asset('pictures/Mistake.jpg')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Forex.com. (2021a). 5 Common Forex Trading Mistakes. https://www.forex.com/en/education/education-themes/trading-concepts/common-forex-trading-mistakes/</b></p>
        </div>
        </div>
    </div>
</div>
