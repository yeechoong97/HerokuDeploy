...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2380px;">
            ...
            <ol>
                <li><b>Select a currency pair</b></li>
                ...
                <li><b>Read the quote</b></li>
                <img src ="{{asset('pictures/QuoteSample.png')}}" class="img-padding" ><br>
            ...
            <img src ="{{asset('pictures/BuyPositionSample.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/SellPositionSample.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Forex.com. (2021c). How to Trade Forex. https://www.forex.com/en/education/resources-by-level/beginner/how-to-trade-forex/</b></p>
        </div>
        </div>
    </div>
</div>
