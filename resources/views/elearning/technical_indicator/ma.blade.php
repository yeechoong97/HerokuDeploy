...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 3780px;">
            ...
            <img src ="{{asset('pictures/SMA.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/SMAFormula.png')}}" class="img-padding" >
            <p>For example, looking at a 5-day SMA on a daily chart of EUR/USD and the closing prices over the 5 days are as follows:</p>
            <img src ="{{asset('pictures/SMACalculation.png')}}" class="img-padding" > 
            <h5>Exponential Moving Average</h5>
            <img src ="{{asset('pictures/EMAFormula.png')}}" class="img-padding" > 
            ...
            <ol>
                ...
                <img src ="{{asset('pictures/SupportResistance.png')}}" class="img-padding" > 
            ...
            <p>*Adapted from <b>Costa, T. Da. (2019). Moving Average (MA) Explained for Traders. https://www.dailyfx.com/education/technical-analysis-tools/moving-average.html</b></p>
        </div>
        </div>
    </div>
</div>
