...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2280px;">
            ...
            <img src ="{{asset('pictures/MFI.png')}}" class="img-padding" >
            <h5>The Formulas for the Money Flow Index Are:</h5>
            <img src ="{{asset('pictures/MFIFormula.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Mitchell, C. (2020d). Money Flow Index - MFI Definition and Uses. https://www.investopedia.com/terms/m/mfi.asp</b></p>
        </div>
        </div>
    </div>
</div>
