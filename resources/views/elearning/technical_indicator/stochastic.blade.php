...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2380px;">
            ...
            <img src ="{{asset('pictures/StochasticFormula.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/Stochastic.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Hayes, A. (2020a). Stochastic Oscillator. https://www.investopedia.com/terms/s/stochasticoscillator.asp</b></p>
        </div>
        </div>
    </div>
</div>
