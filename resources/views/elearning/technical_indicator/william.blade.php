...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2080px;">
            ...
            <img src ="{{asset('pictures/William.png')}}" class="img-padding" >
            <h5>The Formula for the Williams %R is :</h5>
            <img src ="{{asset('pictures/WilliamFormula.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Mitchell, C. (2020e). Williams %R Definition and Uses. https://www.investopedia.com/terms/w/williamsr.asp</b></p>
        </div>
        </div>
    </div>
</div>
