...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2380px;">
            ...
            <img src ="{{asset('pictures/CCIFormula.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/CCI.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Mitchell, C. (2021a). Commodity Channel Index (CCI). https://www.investopedia.com/terms/c/commoditychannelindex.asp</b></p>
        </div>
        </div>
    </div>
</div>
