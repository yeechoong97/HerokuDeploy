...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2580px;">
            ...
            <img src ="{{asset('pictures/ROC.png')}}" class="img-padding" >
            <h5>Formula For the Rate Of Change</h5>
            <img src ="{{asset('pictures/ROCFormula.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Mitchell, C. (2020d). Price Rate Of Change Indicator (ROC). https://www.investopedia.com/terms/p/pricerateofchange.asp</b></p>
        </div>
        </div>
    </div>
</div>
