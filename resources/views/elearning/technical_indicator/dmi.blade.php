...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2380px;">
            ...
            <img src ="{{asset('pictures/DMIFormula.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/DMI.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Mitchell, C. (2021b). Directional Movement Index (DMI). https://www.investopedia.com/terms/d/dmi.asp</b></p>
        </div>
        </div>
    </div>
</div>
