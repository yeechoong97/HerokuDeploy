...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 3080px;">
            ...
            <img src ="{{asset('pictures/RSIStep1Formula.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/RSIStep1Example.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/RSIStep2Formula.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/RSI.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/Adjusted.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Fernando, J. (2020). Relative Strength Index (RSI). https://www.investopedia.com/terms/r/rsi.asp</b></p>
        </div>
        </div>
    </div>
</div>
