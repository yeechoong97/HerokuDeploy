...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2680px;">
            ...
            <img src ="{{asset('pictures/Aroon.png')}}" class="img-padding" >
            <h5>The Formula for the Aroon Oscillator is</h5>
            <img src ="{{asset('pictures/AroonFormula.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Mitchell, C. (2019). Aroon Oscillator. https://www.investopedia.com/terms/a/aroonoscillator.asp</b></p>
        </div>
        </div>
    </div>
</div>
