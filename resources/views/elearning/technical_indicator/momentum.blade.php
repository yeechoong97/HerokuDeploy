...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2080px;">
            ...
            <img src ="{{asset('pictures/Momentum.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/MomentumFormula.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Investopedia.com. (2021). Momentum Indicates Stock Price Strength. https://www.investopedia.com/articles/technical/081501.asp</b></p>
        </div>
        </div>
    </div>
</div>
