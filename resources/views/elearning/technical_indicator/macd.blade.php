...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2280px;">
            ...
            <img src ="{{asset('pictures/MACD.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/MACDSignal.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Venketas, W. (2019c). What the MACD Indicator is and How it Works. https://www.dailyfx.com/education/technical-analysis-tools/macd-indicator.html</b></p>
        </div>
        </div>
    </div>
</div>
