    ...
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2100px;">
            <div class="sidenav-content-details">
                ...
                <img src ="https://res.cloudinary.com/fyp202105/image/upload/v1612767662/E-Learning/MACD.png" class="img-padding" alt="macd">
                ...
                <ul>
                    <li>When the MACD line crosses <strong>ABOVE</strong> the zero line, this signals an uptrend</li>
                    <li>When the MACD line crosses <strong>BELOW</strong> the zero line, this signals an downtrend</li>
                </ul>
                <p>In addition, the MACD signals buy or sell orders which are given when the two MACD lines cross over as outlined below:</p>
                <ul>
                    <li>When the MACD line crosses <strong>ABOVE</strong> the signal line, traders use this as a <strong>BUY</strong> indication</li>
                    <li>When the MACD line crosses <strong>BELOW</strong> the signal line, traders use this as a <strong>SELL</strong> indication</li>
                </ul>
                <img src ="https://res.cloudinary.com/fyp202105/image/upload/v1612767662/E-Learning/MACDSignal.png" class="img-padding" alt="macd-signal">
                ...
                <ol>
                    ...
                    <li><strong>Signal Line</strong> : 9-Period EMA</li>
                    <li><strong>Histogram</strong> : Difference between MACD line and Signal line
                </ol>
