    ...
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2500px;">
            <div class="sidenav-content-details">
                ...
                <p class="citation">*Adapted from <cite>Mitchell, C. (2021.). Accumulation/Distribution Indicator (A/D). 2021. Retrieved February 7, 2021, from https://www.investopedia.com/terms/a/accumulationdistribution.asp</cite></p>
            </div>
        </div>
    </div>
</div>
