...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2280px;">
            ...
            <img src ="{{asset('pictures/ADLFormula.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/ADL.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Mitchell, C. (2021.). Accumulation/Distribution Indicator (A/D). 2021. Retrieved February 7, 2021, from https://www.investopedia.com/terms/a/accumulationdistribution.asp</b></p>
        </div>
        </div>
    </div>
</div>
