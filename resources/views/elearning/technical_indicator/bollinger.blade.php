...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2480px;">
            ...
            <img src ="{{asset('pictures/BollingerFormula.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/Bollinger.png')}}" class="img-padding" >
            <h5>The Squeeze</h5>
            ...
            <p>*Adapted from <b>Hayes, A. (2020a). Bollinger Band® Definition. https://www.investopedia.com/terms/b/bollingerbands.asp</b></p>
        </div>
        </div>
    </div>
</div>
