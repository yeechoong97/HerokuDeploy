...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 2480px;">
            ...
            <img src ="{{asset('pictures/PSARFormula.png')}}" class="img-padding" >
            ...
            <img src ="{{asset('pictures/PSAR.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Mitchell, C. (2021c). Parabolic SAR (Stop and Reverse) Indicator Definition and Uses. https://www.investopedia.com/terms/p/parabolicindicator.asp</b></p>
        </div>
        </div>
    </div>
</div>
