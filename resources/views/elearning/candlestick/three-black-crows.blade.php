...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1480px;">
            ...
            <img src ="{{asset('pictures/ThreeBlackCrows.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Majaski, C. (2021). Three Black Crows. https://www.investopedia.com/terms/t/three_black_crows.asp</b></p>
        </div>
        </div>
    </div>
</div>
