...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1280px;">
            ...
            <img src ="{{asset('pictures/EveningStar.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Fernando, J. (2021). Evening Star. https://www.investopedia.com/terms/e/eveningstar.asp</b></p>
        </div>
        </div>
    </div>
</div>
