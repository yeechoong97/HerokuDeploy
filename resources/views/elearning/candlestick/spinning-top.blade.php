    ...
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1500px;">
            <div class="sidenav-content-details">
                ...
                <img src ="https://res.cloudinary.com/fyp202105/image/upload/v1612765668/E-Learning/SpinningTop.png" class="img-padding" >
                ...
                <p class="citation">*Adapted from <cite>Mitchell, C. (2021). Spinning Top Candlestick. https://www.investopedia.com/terms/s/spinning-top.asp</cite></p>
            </div>
        </div>
    </div>
</div>
