...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1380px;">
            ...
            <img src ="{{asset('pictures/SpinningTop.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Mitchell, C. (2021). Spinning Top Candlestick. https://www.investopedia.com/terms/s/spinning-top.asp</b></p>
        </div>
        </div>
    </div>
</div>
