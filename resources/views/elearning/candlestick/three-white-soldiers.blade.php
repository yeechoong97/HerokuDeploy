...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1180px;">
            ...
            <img src ="{{asset('pictures/ThreeWhiteSoldiers.png')}}" class="img-padding" >
            ...
            <p>*Adapted from <b>Chen, J. (2020c). Three White Soldiers Definition. https://www.investopedia.com/terms/t/three_white_soldiers.asp</b></p>
        </div>
        </div>
    </div>
</div>
