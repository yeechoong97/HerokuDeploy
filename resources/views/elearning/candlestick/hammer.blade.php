...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1280px;">
            ...
            <img src ="{{asset('pictures/Hammer.png')}}" class="img-padding" >
            ...
            <p>Hammers aren't usually used in isolation, even with confirmation. Traders typically utilize price or trend analysis, or technical indicators to further confirm candlestick patterns.</p>
            <p>Hammers occur on all time frames, including one-minute charts, daily charts, and weekly charts.</p>
            <p>*Adapted from <b>Mitchell, C. (2020). Hammer Candlestick. https://www.investopedia.com/terms/h/hammer.asp</b></p>
        </div>
        </div>
    </div>
</div>
