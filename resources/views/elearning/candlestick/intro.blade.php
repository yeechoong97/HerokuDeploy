...
<div class="elearning-container">
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1180px;">
            ...
            <p>*Adapted from <b>Galstyan, M. (2021). Using Bullish Candlestick Patterns To Buy Stocks. https://www.investopedia.com/articles/active-trading/062315/using-bullish-candlestick-patterns-buy-stocks.asp</b></p>
        </div>
        </div>
    </div>
</div>
