    ...
    <div class="row elearning-subcontainer">
        ...
        <div class="col-md-6 col-xl-10 offset-xl-0 sidenav-con" style="height: 1200px;">
            <div class="sidenav-content-details">
                ...
                <p class="citation">*Adapted from <cite>Galstyan, M. (2021). Using Bullish Candlestick Patterns To Buy Stocks. https://www.investopedia.com/articles/active-trading/062315/using-bullish-candlestick-patterns-buy-stocks.asp</cite></p>
            </div>
        </div>
    </div>
</div>
