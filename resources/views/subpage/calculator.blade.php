                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane tab-contents fade show active" id="margin" role="tabpanel" aria-labelledby="margin-tab">
                        <div class="calculator-left-div" id="calculator-left-div-intro">
                            ...
                            <label class="text-left ml-4 my-2"><strong>Required Margin</strong></label>
                        ...
                        <div class="calculator-right-div" id="calculator-right-div-intro">
                            ...
                            <label class="text-left my-2">Trading <strong style="color:blue">30,000</strong> Units of EUR/USD (<strong style="color:red">1.13798</strong>) using <strong style="color:purple">50:1</strong> leverage with an account denominated in USD.</label>
                            <label class="text-left">Trade Size: <strong style="color:blue">30,000</strong></label><br/>
                            <label class="text-left">Currency Exchange Rate: <strong style="color:red">1.13798</strong></label><br/>
                            <label class="text-left">Leverage: <strong style="color:purple">50:1</strong></label>
                            <br/><br/>
                    ...
                    <div class="calculator-left-div">
                            ...
                            <label class="text-left ml-4 my-2"><strong>Pips Value</strong></label>
                        ...
                        <div class="calculator-right-div">
                            ...
                            <label class="text-left my-2">Account Base Currency : <strong>EUR</strong></label><br/>
                            <label class="text-left">Currency Pair : <strong>EUR/USD</strong></label><br/>
                            <label class="text-left">One Pip : <strong style="color:blue">0.0001</strong></label><br/>
                            <label class="text-left">Currency Rate: <strong style="color:red">1.08962</strong></label><br/>
                            <label class="text-left">Units: <strong style="color:purple">100000</strong></label>
                            <br/><br/>
                    ...
                    <div class="tab-pane tab-contents fade" id="profit" role="tabpanel" aria-labelledby="profit-tab">
                        <div class="calculator-left-div">
                            ...
                            <label class="text-left ml-4 my-2"><strong>Profit Value</strong></label>
                        ...
                        <div class="calculator-right-div">
                            ...
                            <hr>
                            <label class="text-left font-weight-bold">Example</label><br/>
                            <label class="text-left my-2">Account Base Currency : <strong>USD</strong></label><br/>
                            <label class="text-left">One Pip : <strong>0.0001</strong></label><br/>
                            <label class="text-left">Currency Pair : <strong>EUR/USD</strong></label><br/>
                            <label class="text-left">Type : <strong>Buy</strong></label><br/>
                            <label class="text-left">Entry Price : <strong style="color:blue">1.12336</strong></label><br/>
                            <label class="text-left">Entry Price : <strong style="color:brown">1.12444</strong></label><br/>
                            <label class="text-left">Pips: <strong style="color:red">10.8</strong> (0.00108 ✕ 10000)</label><br/>
                            <label class="text-left">Units: <strong style="color:purple">100000</strong></label>
                            <br/><br/>
