...
<div class="col-3 px-0">
    ...
    <div class="bg-gray px-4 pt-2 bg-light leave-border">
        <a href="#" id="join-btn"class="form-control btn-danger col-md-10 mx-auto text-center" onclick="checkLeaveRoom()">Leave</a>
...
<div class="col-9 px-0">
    ...
    <div class="input-group" style="height:44px;">
        ...
        <div class="input-group-append">
            <button id="button-addon2"  class="btn btn-link"> <span class="fa fa-paper-plane"></span></button>
        </div>
    </div>
    </form>
</div>
