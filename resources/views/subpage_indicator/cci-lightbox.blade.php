<div class="modal fade" id="CCI-modal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body-indicator">
                    ...
                    <hr>
                <div class="btn-body">
                    <button class="form-control btn-primary col-md-2 btn-align-right" id="cci_indicator_btn">Add</button>
                    <button class="form-control btn-danger col-md-2 btn-align-right" id="CCI-exit-modal" data-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
    </div>
