<div id ="OBV_indicator_box" class="lightbox">
    <div class="modal modal-content2 decrease-body-height">
        <div class="modal-header">
            <div class="modal-title">On-Balance Volume (OBV)</div>
            <span aria-hidden="true" class="close" aria-label="Close" onclick="toggleLightboxIndicator('OBV')">&times;</span>
        </div>
        ...
        <div class="modal-body-indicator">
            ...
            <hr>
            <div class="btn-body">
                <button class="btn form-control btn-primary col-md-2 btn-align-right" id="obv_indicator_btn">Add</button>
                <button class="btn form-control btn-danger col-md-2 btn-align-right" onclick="toggleLightboxIndicator('OBV')">Cancel</button>
            </div>
        </div>
    </div>
</div>
